    ...
    // Slide 6: The Plan - Sitemap (Two-panel view)
    {
      ...
      content: {
        ...
        rightPanel: {
          ...
          items: [
            { icon: "DollarSign", title: "Tax Planning", description: "Preparation & strategy" },
            { icon: "BarChart", title: "Bookkeeping", description: "Accounting services" },
            { icon: "Lightbulb", title: "Tax Advisory", description: "Business & tax strategy" },
            { icon: "PieChart", title: "CFO Services", description: "Fractional CFO support" },
            { icon: "Users", title: "Payroll", description: "Payroll & employee benefits" },
          ],
        },
      },
    },
